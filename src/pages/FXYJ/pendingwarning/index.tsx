...
interface TableListProps extends FormComponentProps {
  ...
  loading: boolean;
  listTableListPendingWarning: StateType;
}
...
class TableList extends Component<TableListProps, TableListState> {
  ...
  componentDidMount() {
    ...
    setInterval(() => {
      dispatch({
        type: 'listTableListPendingWarning/fetch',
      });
    }, 1000);
  }
  ...
  render() {
    const {
      listTableListPendingWarning: { data },
      loading,
    } = this.props;
